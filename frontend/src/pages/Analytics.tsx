  ...
  return (
    <div className="page">
      <div className="page-header">
        ...
        <p className="page-subtitle">Aggregate call statistics across all captures</p>
      </div>
      ...
      <div className="charts-grid">
        ...
        <div className="chart-card">
          ...
          {data.calls_by_day.length === 0 ? (
            <p style={{ color: "#9e9e9e", fontSize: "14px" }}>No data available.</p>
          ) : (
            <div className="day-chart">
              {data.calls_by_day.map((day) => (
                <div key={day.date} className="day-bar-col" title={`${day.date}: ${day.count} calls`}>
                  <div
                    className="day-bar"
                    style={{ height: `${Math.max(4, (day.count / maxDay) * 120)}px` }}
                  />
